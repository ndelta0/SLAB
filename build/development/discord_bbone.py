...
async def on_message(message):
    ...
    if message.channel.id in boundChannels:
        if message.content.lower().startswith('%shello' % PREF):
            ...
            helpEmbed.add_field(name='%ssearch <query>'%PREF, value='Allows you to search for a song to add to playlist', inline=False)
            ...
            helpEmbed.add_field(name='%screate <name>'%PREF, value='Creates playlist with name <name>', inline=True)
            helpEmbed.add_field(name='%sdelete <name>'%PREF, value='Deletes playlist with name <name>', inline=True)
